...
TEST_F(RoutePlannerTest, ThrowsInvalidCoordinatesError)
{
    EXPECT_THROW(RoutePlanner planner(model, -10, 50, 50, 50), InvalidCoordinatesError);
    EXPECT_THROW(RoutePlanner planner(model, 110, 50, 50, 50), InvalidCoordinatesError);
}

TEST_F(RoutePlannerTest, ThrowsEmptyNodeError)
{
    RoutePlanner planner(model, 10, 10, 90, 90);
    EXPECT_THROW(planner.CalculateHValue(nullptr), EmptyNodeError);
}